<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Comisiones.aspx.cs" Inherits="WebUI.Administrador.Comisiones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageHeader" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" runat="server">

    <asp:Panel ID="gridPanel" runat="server" HorizontalAlign="Center">
        <asp:GridView ID="dgvComisiones" runat="server" Width="810px" AutoGenerateColumns="False" DataKeyNames="ID" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" CellSpacing="2" ForeColor="Black" GridLines="None" OnSelectedIndexChanged="dgvComisiones_SelectedIndexChanged" >
    ...
    <asp:Panel ID="formPanel" Visible="false" runat="server">
        ...
        <br />
        <asp:Label ID="lblAnioEspecialidad" runat="server" Text="Año Especialidad" Width="130px"></asp:Label>
        <asp:TextBox ID="txtAnioEspecialidad" runat="server" Height="16px" Width="210px"></asp:TextBox>
        <br />
        <asp:Label ID="lblIdPlan" runat="server" Text="Plan" Width="130px"></asp:Label>
